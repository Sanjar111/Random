...
public class OmadShou {
    ...
    public static void main(String[] args) {
        ...
        String kod[]={"33","88","90","91","93","94","97","99"}; //+9989xx 777 77 77
        int a=kod.length;
        ...
        int n= random.nextInt(9); //+99897 777 77 7x

        System.out.println("Keyingi o'yinda +998"+kod[b]+s+d+f+g+h+j+n+"raqam egasi ishtirok etadi");
